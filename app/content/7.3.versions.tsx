...
const points = [
  <>
    ...
    <br />
    users can control update
    <br />
    frequency, e.g. mobile apps
  </>,
  <>
    Or for a products with a<br />
    planned roadmap
  </>,
  "Consider SemVer semantics",
];

const toggleConfig = `
MY_COOL_FEATURE=v1.2.3
A_HUGE_FEATURE=v2.0.0
`;

export function VersionToggles() {
  return (
    <Slide>
      <SlideHeader>Version toggles</SlideHeader>
      <SideBySide
...
function Image() {
  return (
    <svg
      ...
      className="absolute right-[500px] -bottom-[2px]"
    >
      <path
        d="M883.92335,679.03677c-13.32974,39.04189-30.47207,77.99971-52.43309,115.07876-.48744.835-.98036,1.65342-1.47751,2.48541l-54.36844-17.2001c.31277-.787.65529-1.66776,1.02323-2.62911,21.92914-56.71074,154.23254-402.23642,148.294-470.36194C925.60081,311.98621,946.29807,496.53049,883.92335,679.03677Z"
        transform="translate(-205 -99.00391)"
        fill="#e6e6e6"
      />
      <path
        d="M841.97922,797.43384c-.73886.75543-1.497,1.50475-2.26061,2.23766l-40.786-12.90312c.55137-.66713,1.19352-1.45315,1.93189-2.34165,12.07938-14.75186,47.99146-58.91856,83.05881-105.39,37.68531-49.9396,74.40225-102.533,79.54812-124.14378C962.43788,559.80726,930.25528,709.40339,841.97922,797.43384Z"
        transform="translate(-205 -99.00391)"
        fill="#e6e6e6"
      />
      <path
      ...
      <path
        ...
        fill="#e6e6e6"
      />
      <circle cx="117.102" cy="309.88012" r="26.2388" fill="#ffb8b8" />
      <path
